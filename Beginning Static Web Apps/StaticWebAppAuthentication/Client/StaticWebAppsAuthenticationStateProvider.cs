...
{
    public static bool TryGetClaimsFromClientClaimsPrincipal(
    ...
    private async Task<TryGetAsyncResult<ClientPrincipal>> TryGetClientPrincipalAsync()
    {
       ...
       GetAuthenticationStateAsync()
    {
        ...
        try
        {
            ...
            if (getClientPrincipalResponse is null)
            {
